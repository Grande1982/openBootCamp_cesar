...
public class EmployeeDAOImpl implements EmployeeDAO {
    ...
    @Override
    public List<Employee> findAllCesar() {

        Session session = HibernateUtil.getSessionFactory().openSession();
        List<Employee> employees = session.createNativeQuery("SELECT * FROM ob_employees").list();

        for(Employee per : employees) {
    ...
    public List<Employee> findAll() {
        ...
        // equivalente: List<Employee> employees = session.createQuery("from Employee", Employee.class).list();
        session.close();
